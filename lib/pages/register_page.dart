...
import 'package:app_interactivos/user_auth/presentation/widgets/form_container_widget.dart';

/*features/user_auth/firebase_auth_implementation/firebase_auth_services.dart';
...
setState(() {
  isSigningUp = false;
    ...
    if (user != null) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => HomePage(user: email, password: password)));
