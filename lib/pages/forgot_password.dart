...
return Scaffold(
        ...
        Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 10,),
              FadeInUp(duration: Duration(milliseconds: 1300), child: Text("Forgot password", style: TextStyle(color: Colors.white, fontSize: 18),)),
            ],
          ),
        ),
        SizedBox(height: 20),
  ...
  Future<void> _resetPassword(String recovery_email) async {
    final String email = recovery_email;
    ...
    if (email.isNotEmpty) {
      ...
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('An error occured sending recovery email'),
          ),
        );
